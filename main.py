...
# p_train_loader = RandomNodeSampler(data, num_parts=5, shuffle=True,
#                                 num_workers=5)
# k = int(data.num_nodes / 10)
...
# #             f'Val: {valid_rocauc:.4f}, Test: {test_rocauc:.4f}')
# #     else:
# #         loss = train_wprune(epoch, k)
# #         train_rocauc, valid_rocauc, test_rocauc = test_wprune()
# #         print(f'Loss: {loss:.4f}, Train: {train_rocauc:.4f}, '
# #             f'Val: {valid_rocauc:.4f}, Test: {test_rocauc:.4f}')
