...
print(homo_data.train_mask.nonzero().size())
homo_data.train_mask = torch.zeros((node_type.size(0)), dtype=torch.bool)
homo_data.train_mask[local2global['paper'][split_idx['valid']['paper']]] = True
print(homo_data.train_mask.nonzero().size())

homo_data.train_mask = torch.zeros((node_type.size(0)), dtype=torch.bool)
homo_data.train_mask[local2global['paper'][split_idx['test']['paper']]] = True
print(homo_data.train_mask.nonzero().size())
